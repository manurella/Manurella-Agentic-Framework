...
- `tools/self_check.py`: one-command local smoke suite for framework contracts, end-to-end Core/Brain session compilation, governed memory, Kilo export, and eval helpers.
