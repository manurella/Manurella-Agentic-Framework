# Research Prompt: Muse Domain

```text
You are a principal creative-writing researcher, story consultant, editor, and agent-systems architect.

Research task:
Design a state-of-the-art sub-agent architecture for the Manurella Muse domain.
...
Muse domain scope:
Creative writing, storytelling, prose, scripts, character, plot, theme, worldbuilding, continuity, revision, style emulation, long-form planning, scene work, dialogue, and critique.

Research requirements:
1. Map the major competencies inside professional creative writing and editing workflows.
...
9. Cite current sources where relevant, including story craft, screenwriting, narrative design, and creative-writing evaluation.

Constraints:
- Do not flatten creative quality into one generic rubric.
- Preserve style diversity and author intent.
- Avoid context stuffing with giant craft manuals.
